...
\begin{itemize}
	\item uruchomić przesyłanie sygnału zegarowego do 32-bitowego timera o numerze zero (C32B0) \cite{INST}: 
	\begin{verbatim}
	LPC_SYSCON->SYSAHBCLKCTRL |= (1<<9);
	\end{verbatim}
	\item wybrać pin 5 z portu 1 do odbierania sygnału z wejścia input 0 C32B0
	\item ustawiamy wejście sygnału z match registrów 0 - 2 port1.6, 1.7, 0.1
	\item w match registrze timera ustawiamy interwał
	\item w match control registrze ustawiamy \verb|0b11| - wyślij przerwanie i zresetuj jeżeli MR0
