...
\begin{itemize}
	\item Timer;\qquad\qquad\qquad\qquad\qquad{Krzysztof Wierzbicki}
	\item GPIO;\qquad\qquad\qquad\qquad\qquad{Jan Filipowicz}
	\item ADC; \qquad\qquad\qquad\qquad\qquad{Turoboś Filip}
	\item SPI/SSP;\qquad\qquad\qquad\qquad\qquad{Jan Filipowicz}
	\item I$^2$C; \qquad\qquad\qquad\qquad\qquad{Krzysztof Wierzbicki}
	\item Wyświetlacz siedmiosegmentowy; \qquad{Turoboś Filip}
	\item Wyświetlacz LCD; \qquad\qquad\qquad\qquad{Krzysztof Wierzbicki}
	\item Przerwania; \qquad\qquad\qquad\qquad\qquad{Krzysztof Wierzbicki}
	\item DAC; \qquad\qquad\qquad\qquad\qquad\qquad\qquad{Jan Filipowicz}
	\item Akcelerometr; \qquad\qquad\qquad\qquad\qquad{Krzysztof Wierzbicki}
	\item Czujnik światła; \qquad\qquad\qquad\qquad\qquad{Turoboś Filip}
	\item Diody LED -- Ekspander (PCA 9532); \qquad\qquad\qquad\qquad\qquad{Turoboś Filip}
\end{itemize}
